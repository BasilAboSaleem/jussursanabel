...
const activityLogSchema = new mongoose.Schema({
    ...
    action: { 
        ...
        enum: [
            ...
            'settings_update', 'content_management_update', 'chat_request_handle', 'chat_request_create',
    ...
    targetType: { type: String, enum: ['User', 'Case', 'Transaction', 'ChatRequest', 'Settings', 'ContentManagement', 'AdminRequest', 'CaseUpdate', 'BankReceipt', 'Payout'] },
